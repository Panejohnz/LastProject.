        ...
        <div class="col-md-9">
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-4">      
                        ...
                        <input type="number" min="10" id="tel" class="form-control" name="tel" value="<?php echo  $this->session->flashdata('tel'); ?>" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" title="กรุณากรอกให้ครบ 10 หลัก 0800000000" maxlength="10">
                    </div>
