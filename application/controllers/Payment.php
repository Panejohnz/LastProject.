...
class Payment extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['results'] = $this->Payment_model->fetch_imgtype($config['per_page'], $page, $this->input->get('keyword'));
    ...
    {
        $this->load->view('template/backheader');
        $this->load->view('payment/newdata');
        $this->load->view('template/backfooter');
    }
    ...
    */
    ...
    {
        $data['result'] = $this->payment_model->read_imgtype($id);
        $this->load->view('template/backheader');
    ...
    public function confrm($id)
    {
        $data = array(
            'backlink'  => 'payment',
            'deletelink'=> 'payment/remove/' . $id
        );
        $this->load->view('template/backheader');
        $this->load->view('payment/confrm', $data);
        $this->load->view('template/backfooter');
    }

    public function remove($id)
    {
        $this->payment_model->remove_roomcategory($id);
        redirect('payment', 'refresh');
    }
